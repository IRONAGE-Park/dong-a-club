const clubs = [
    { id: 1, division_id: 1, address: '416', leader: { name: '남윤지', phone: '010-5263-5502' }, name: '따듯한 사람들', attribute: ['travel', 'many'] },
    ...
    { id: 3, division_id: 1, address: '421', leader: { name: '김동길', phone: '010-2774-9480' }, name: '커피헤븐', attribute: ['drink'] },
    ...
    { id: 5, division_id: 1, address: '533', leader: { name: '임정균', phone: '010-4152-3196' }, name: '다연회', attribute: ['car'] },
    ...
    { id: 7, division_id: 1, address: '614', leader: { name: '송우석', phone: '010-6788-5235' }, name: '유스호스텔', attribute: ['travel', 'few', 'regularly'], image: 'youth_hostel.png', intro: '대학도 왔는데 여행은 어때? 낭만과 설렘이 가득한 여행동아리 유스호스텔! 같이 여행갈래?' },
    ...
    { id: 9, division_id: 1, address: '615', leader: { name: '김민건', phone: '010-4107-2313' }, name: '하늘별', attribute: ['star'] },
    ...
    { id: 14, division_id: 2, address: '419', leader: { name: '김덕균', phone: '010-6274-8583' }, name: '2L', attribute: [] },
    { id: 15, division_id: 2, address: '405', leader: { name: '장인수', phone: '010-2448-5732' }, name: '유니피스', attribute: [] },
    { id: 16, division_id: 2, address: '504', leader: { name: '김규민', phone: '010-4964-8555' }, name: '유네스코', attribute: [], image: 'unesco.png', intro: '역사가 깊은 학술동아리 다양한 과들과 함께 어우러진 친목을 다지는 동아리 주점 및 다양한 행사 많음 이쁘고 잘생긴 형언니들과 함께 많을 추억을 만들수 있음 1주에 한번 정기집회 토론과 스피치 활동 각종 봉사활동과 농활등 다양한 활동' },
    ...
    // 학술 2
    { id: 18, division_id: 3, address: '508', leader: { name: '백승훈', phone: '010-4147-1146' }, name: '열린그림마당', attribute: [] },
    ...
    { id: 20, division_id: 3, address: '503', leader: { name: '이정민', phone: '010-8853-2748' }, name: 'BOA', attribute: [], image: 'boa.jpg', intro: '반갑습니다! 미술동아리 Boa입니다! 다양한 취미활동! 친목! boa에서 즐겨보세요! ' },
    ...
    { id: 23, division_id: 3, address: '412', leader: { name: '송영현', phone: '010-4445-1743' }, name: '팝콘', attribute: [] },
    ...
    // 문예 1
    { id: 25, division_id: 4, address: '613', leader: { name: '김보미', phone: '010-2345-8027' }, name: '스트리츠', attribute: [], image: 'streets.jpg', intro: '동아대 최대규모 밴드 스트리츠! 락, 어쿠스틱, 밴드, 버스킹 등 폭넓은 장르를 다룹니다!' },
    ...
    { id: 29, division_id: 4, address: '409', leader: { name: '배동혁', phone: '010-5479-8876' }, name: '동아극예술연구회', attribute: [], image: 'dong-a-theater.jpg', intro: '☆동아대학교 유일한 연극동아리☆<br/> 연극에 대한 열정으로 각자의 매력을 찾아보세요!<br/> ♧누구나 대.환.영♧' },
    { id: 30, division_id: 4, address: '602', leader: { name: '권진솔', phone: '010-9845-3167' }, name: '한아리국악회', attribute: [] },
    { id: 31, division_id: 4, address: '605', leader: { name: '서민성', phone: '010-3161-9474' }, name: 'FGC', attribute: [], image: 'fgc.jpg', intro: '음악을 좋아하는, 사람을 좋아하는, 놀기 좋아하는 모든人 환영합니다. FGC에 놀러오세요~' },
    ...
    { id: 33, division_id: 4, address: '617', leader: { name: '류동완', phone: '010-2380-5988' }, name: '가리온', attribute: [], image: 'karion.jpg', intro: '중앙댄스동아리 가리온은 힙합을 베이스로 한 다양한 장르의 댄스를 다루고 있는 스트릿댄스동아리입니다!◀' },
    ...
    { id: 36, division_id: 4, address: '606', leader: { name: '박준희', phone: '010-9208-2248' }, name: '노래의 메아리', attribute: [], image: 'echo_of_song.png', intro: '어쿠스틱 기타 등 여러악기의 연주 및 다같이 노래하는 분위기로 친목도모' },
    { id: 37, division_id: 4, address: '607', leader: { name: '김관호', phone: '010-7139-2205' }, name: '동아합창단', attribute: [] },
    ...
    { id: 40, division_id: 5, address: '408', leader: { name: '유정민', phone: '010-8270-5705' }, name: '내쇼날', attribute: [] },
    ...
    // 봉사
    { id: 50, division_id: 6, address: '525', leader: { name: '안태규', phone: '010-9158-4160' }, name: '동아가톨릭학생회', attribute: [], image: 'catholic.jpeg', intro: '저희는 대학생들의 신앙생활과 친목도모를 지원하여 신앙생활에 보탬이 되어 드립니다.' },
    ...
    { id: 52, division_id: 6, address: '514', leader: { name: '민재기', phone: '010-4421-8863' }, name: 'IVF', attribute: [], image: 'IVF.png', intro: '"말씀, 오늘도 맛있게 잘 먹었습니다!"<br/>재밌게 성경을 연구하는 끈끈한 공동체!' },
    { id: 53, division_id: 6, address: '414', leader: { name: '김시은', phone: '010-9661-5288' }, name: '인터콥(캠퍼스)', attribute: [] },
    { id: 54, division_id: 6, address: '512', leader: { name: '유인재', phone: '010-5950-1131' }, name: '불교학생회(우연히)', attribute: [] },
    ...
    { id: 56, division_id: 6, address: '515', leader: { name: '이소망', phone: '010-5031-6535' }, name: 'SFC', attribute: [] },
    ...
    { id: 59, division_id: 7, address: '522', leader: { name: '채상민', phone: '010-8453-3734' }, name: 'ALPHA', attribute: [] },
    ...
    { id: 62, division_id: 7, address: '527', leader: { name: '김재준', phone: '010-9147-4202' }, name: '두바', attribute: [], image: 'duba.jpg', intro: '동아대학교 중앙 농구 동아리 두바입니다.<br/>남녀노소 매니저.초보 모두 환영입니다.' },
    ...
    { id: 64, division_id: 7, address: '621', leader: { name: '박현준', phone: '010-2394-7718' }, name: '동아탁구회', attribute: [], image: 'pingpong.jpeg', intro: '혼자서도 스포츠를 즐기고 싶다면다른 부산권 학교들과 교류하고싶다면공강시간에 편하게 올 수 있는곳이 필요하다면저희 동아탁구회로 오세요~~' },
    { id: 65, division_id: 7, address: '532', leader: { name: '김소진', phone: '010-6458-6673' }, name: '테티스', attribute: [] },
    { id: 66, division_id: 7, address: '530', leader: { name: '전세훈', phone: '010-4776-7980' }, name: '동아수영회', attribute: [], image: 'swim.jpg', intro: '저희는 대학생들의 신앙생활과 친목도모를 지원하여 신앙생활에 보탬이 되어 드립니다.' },
    ...
    { id: 68, division_id: 7, address: '411', leader: { name: '김태훈', phone: '010-2221-2540' }, name: 'WAY', attribute: [] },
    ...
    { id: 74, division_id: 7, address: '601', leader: { name: '윤호진', phone: '010-9967-9757' }, name: '파이', attribute: [], image: 'pi.jpg', intro: '저희 보드동아리(파이)는 롱보드를 중심으로 트릭 / 댄싱 등 여러 기술들을 연습하며, 다양한 보드를 다루는 동아리입니다.' },
    // 체육
    ...
    { id: 76, division_id: 8, address: '425', leader: { name: '최성빈', phone: '010-5550-4924' }, name: '풀섶', attribute: [], image: 'PS.jpg', intro: '동아고 삼성여고 졸업생들로 이루어진 동문동아리. 동네 친한 오빠 언니 누나 형처럼 다같이 추억을 만들며 대학생활을 보내요~~!' },
    // 동문
];
