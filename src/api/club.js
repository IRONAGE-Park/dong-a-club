const clubs = [
    ...
    { id: 5, division_id: 1, address: '533', leader: { name: '이태원', phone: '010-7724-2852' }, name: '다연회', attribute: ['car'] },
    ...
    { id: 36, division_id: 4, address: '606', leader: { name: '이정목', phone: '010-5064-2497' }, name: '노래의 메아리', attribute: [], image: 'echo_of_song.png', intro: '어쿠스틱 기타 등 여러악기의 연주 및 다같이 노래하는 분위기로 친목도모' },
    ...
    { id: 53, division_id: 6, address: '414', leader: { name: '김시은', phone: '010-9661-5288' }, name: '인터콥(캠퍼스)', attribute: [], intro: ' 인터콥 캠퍼스는 사랑과 섬김의 기독교 가치관에 입각해 아시아·아프리카·중동권의 소외받는 민족과 난민들을 찾아가는 해외봉사 단체입니다.' },
    ...
    { id: 56, division_id: 6, address: '515', leader: { name: '이소망', phone: '010-5031-6535' }, name: 'SFC', attribute: [], intro: '브라운데이운동(낮은 곳에서 섬기시는 어머니 아버님께 감사함을 전하는 운동)과 컨닝추방운동을 하고 있다.' },
    ...
    { id: 76, division_id: 8, address: '425', leader: { name: '고상진', phone: '010-5550-4924' }, name: '풀섶', attribute: [], image: 'PS.jpg', intro: '동아고 삼성여고 졸업생들로 이루어진 동문동아리. 동네 친한 오빠 언니 누나 형처럼 다같이 추억을 만들며 대학생활을 보내요~~!' },
    // 동문
];
